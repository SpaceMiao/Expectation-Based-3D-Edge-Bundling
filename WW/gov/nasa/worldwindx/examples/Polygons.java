...
public class Polygons extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            ArrayList<Position> mLocations = new ArrayList<Position>();
            mLocations.add(Position.fromDegrees(35, -100, 5e4));
            mLocations.add(Position.fromDegrees(35, -80, 5e4));
            mLocations.add(Position.fromDegrees(25, -80, 5e4));
            mLocations.add(Position.fromDegrees(25, -100, 5e4));
//            pgon = new Polygon(mLocations);
//            ShapeAttributes attr = new BasicShapeAttributes();
//            attr.setDrawInterior(true);
//            attr.setInteriorMaterial(Material.RED);
//            attr.setInteriorOpacity(0);
//            pgon.setAttributes(attr);
//            layer.addRenderable(pgon);
