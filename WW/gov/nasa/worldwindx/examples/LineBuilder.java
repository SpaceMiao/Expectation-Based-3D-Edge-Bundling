...
//        this.line.setColor(new Color(255, 0, 0, 100));
...
//        curPos = new Position(curPos.getLatitude(), curPos.getLongitude(), curPos.getAltitude()+200000);
        Vec4 vec = this.wwd.getModel().getGlobe().computePointFromPosition(curPos);
